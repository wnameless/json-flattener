...
/**
 * 
 * {@link JsonFlattenerFactory} preserves the configuration of a JsonFlattener,
 * in doing so, any input JSON data can be used to create a JsonFlattener object
...
public final class JsonFlattenerFactory {
    ...
    /**
     * Creates a {@link JsonFlattener} by given JSON string and configures it
    ...
    /**
     * Creates a {@link JsonFlattener} by given JSON reader and configures it
     * with the configurer and jsonCore within this
     * {@link JsonFlattenerFactory}.
     * 
     * @param jsonReader
